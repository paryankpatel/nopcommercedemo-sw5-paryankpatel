...
public class ElectronicTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        registerPage.enterFirstname("Kiara");
        registerPage.enterLastname("Parikh");
        String email= "random-" + UUID.randomUUID().toString() + "@example.com";
        registerPage.enterEmail(email);
        registerPage.enterPassword("Tango456");
        registerPage.enterConfirmPassword("Tango456");
        ...
        String emailAgain= "random-" + UUID.randomUUID().toString() + "@example.com";
        loginPage.enterEmailId(emailAgain);
        loginPage.enterPassword("Tango456");
        loginPage.clickOnLoginButton();
        shoppingCartPage.termsAndCondition();
        shoppingCartPage.goCheckout();
        billingPage.selectCountry("United Kingdom");
        billingPage.enterCity("London");
        billingPage.enterAddress("67, Maven road");
        billingPage.enterPostcode("T123NG");
        billingPage.enterPhoneNumber("07878613517");
